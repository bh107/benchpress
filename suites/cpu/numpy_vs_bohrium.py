...
scripts = [
    ...
    ('Heat Equation FI',        'heat_equation_fixed',      '--size=10000*10000*10'),
    ('Jacobi',                  'jacobi',                   '--size=10000*10'),
    ('Jacobi Fixed',            'jacobi_fixed',             '--size=10000*10'),
    ...
    ('NBody Nice',              'nbody_nice',               '--size=2000000*10'),
