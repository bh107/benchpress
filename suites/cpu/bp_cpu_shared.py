...
bh_stack_cpu_t32_all = [
    ...
    [
        ...
        ('cpu_vc_fs_t32', 'cpu',    {"BH_CPU_JIT_LEVEL": "2", "OMP_NUM_THREADS": "32"}),
        ('cpu_vc_fs_t16', 'cpu',    {"BH_CPU_JIT_LEVEL": "2", "OMP_NUM_THREADS": "16"}),
        ('cpu_vc_fs_t08', 'cpu',    {"BH_CPU_JIT_LEVEL": "2", "OMP_NUM_THREADS": "8"}),
        ('cpu_vc_fs_t04', 'cpu',    {"BH_CPU_JIT_LEVEL": "2", "OMP_NUM_THREADS": "4"}),
        ('cpu_vc_fs_t02', 'cpu',    {"BH_CPU_JIT_LEVEL": "2", "OMP_NUM_THREADS": "2"}),
        ('cpu_vc_fs_t01', 'cpu',    {"BH_CPU_JIT_LEVEL": "2", "OMP_NUM_THREADS": "1"}),
        ...
        ('cpu_t32', 'cpu',          {"BH_CPU_JIT_LEVEL": "1", "OMP_NUM_THREADS": "32", "BH_CPU_VCACHE_SIZE": "0"}),
        ('cpu_t16', 'cpu',          {"BH_CPU_JIT_LEVEL": "1", "OMP_NUM_THREADS": "16", "BH_CPU_VCACHE_SIZE": "0"}),
        ('cpu_t08', 'cpu',          {"BH_CPU_JIT_LEVEL": "1", "OMP_NUM_THREADS": "8",  "BH_CPU_VCACHE_SIZE": "0"}),
        ('cpu_t04', 'cpu',          {"BH_CPU_JIT_LEVEL": "1", "OMP_NUM_THREADS": "4",  "BH_CPU_VCACHE_SIZE": "0"}),
        ('cpu_t02', 'cpu',          {"BH_CPU_JIT_LEVEL": "1", "OMP_NUM_THREADS": "2",  "BH_CPU_VCACHE_SIZE": "0"}),
        ('cpu_t01', 'cpu',          {"BH_CPU_JIT_LEVEL": "1", "OMP_NUM_THREADS": "1",  "BH_CPU_VCACHE_SIZE": "0"}),
