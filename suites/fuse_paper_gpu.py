...
scripts_gpu = [
    ...
    ('Matrix Mul',          'mxmul',          '--size=2000*100        --dtype=float32'),
    ('Game of Life v1',     'gameoflife',     '--size=8000*8000*100*1 --dtype=float32'),
    ('Game of Life v2',     'gameoflife',     '--size=8000*8000*100*2 --dtype=float32'),
    ('Heat Equation',       'heat_equation',  '--size=8000*8000*100   --dtype=float32'),
    ('Gauss Elimination',   'gauss',          '--size=1000            --dtype=float32'),
    ('LU Factorization',    'lu',             '--size=1000            --dtype=float32'),
    ('Rosenbrock',          'rosenbrock',     '--size=10000000*200    --dtype=float32'),
    ('Stencil1D',           'ndstencil',      '--size=25*4000*1       --dtype=float32'),
    ('Stencil2D',           'ndstencil',      '--size=25*2000*2       --dtype=float32'),
    ('Stencil3D',           'ndstencil',      '--size=25*1000*3       --dtype=float32'),
    ('Stencil4D',           'ndstencil',      '--size=25*500*4       --dtype=float32'),
...
scripts_gpu_no_optimal = [
    ...
    ('N-body',              'nbody',          '--size=3200*50         --dtype=float64'),
...
stack_gpu_no_optimal[3].pop(-1) # pop the optimal fuser
